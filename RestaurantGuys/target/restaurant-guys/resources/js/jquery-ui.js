			...
			.widget(
					"ui.button",
					{
						...
						_create : function() {
							...
							// Can't use _focusable() because the element that
							// receives focus
							// and the element that gets the ui-state-focus
							// class are different
							this._on({
								focus : function() {
									this.buttonElement
					...
					"ui.dialog",
					{
						...
						_createTitlebar : function() {
							...
							this.uiDialogTitlebarClose = $(
								...
								text : false
							}).addClass("ui-dialog-titlebar-close").appendTo(
...
(function($, undefined) {
	...
	$.ui.intersect = function(draggable, droppable, toleranceMode) {
		...
		var draggableLeft, draggableTop, x1 = (draggable.positionAbs || draggable.position.absolute).left, y1 = (draggable.positionAbs || draggable.position.absolute).top, x2 = x1
									...
									._on({
										...
										"click .ui-menu-item:has(a)" : function(
											...
											if (!this.mouseHandled
												...
												// Only set the mouseHandled
												// flag if the event will
												// bubble, see #9469.
												if (!event
					...
					$.ui.mouse,
					{
						...
						_mouseDrag : function(event) {
							...
							for (i = this.items.length - 1; i >= 0; i--) {
								...
								// can cause
								// the placeholder to jitter beetween the outer
								// and inner container.
						...
						_clear : function(event, noPropagation) {
							...
							function delayEvent(type, instance, container) {
								return function(event) {
									container._trigger(type, event, instance
											._uiHash(instance));
								};
							}
							for (i = this.containers.length - 1; i >= 0; i--) {
